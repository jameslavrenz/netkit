...
| Target | Role |
|--------|------|
| **CPU** | Desktop dev — CLI, embedded regression (91 cases), Python ONNX parity (81), AOT compile tests, embedded smoke orchestration on host (`test_mlp`, `cnn_4x4_single`, `speech_kws`) |

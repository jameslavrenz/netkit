#!/usr/bin/env python3
"""Host TensorFlow Lite (LiteRT) float32 MNIST CNN bench.

Pairs with benchmark/netkit/src/mnist_cnn_main.cc:
  - same mnist_cnn.tflite / same float digit vectors from the .nk TCAS
...
DEFAULT_MODEL = ROOT / "benchmark" / "tflm" / "generated" / "mnist_cnn.tflite"
...
def main() -> int:
    ...
    print("TF Lite MNIST CNN float32 benchmark")

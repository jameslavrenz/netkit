#!/usr/bin/env bash
# XIAO ESP32S3 int8 peer A/B: netkit vs TFLM for MNIST CNN + DS-CNN.
#
...
#
# Usage:
#   PORT=/dev/cu.usbmodem21101 ./boards/xiao-esp32s3/scripts/run_esp_int8_ab.sh
#   MODELS="cnn" ./boards/xiao-esp32s3/scripts/run_esp_int8_ab.sh   # CNN only
set -euo pipefail

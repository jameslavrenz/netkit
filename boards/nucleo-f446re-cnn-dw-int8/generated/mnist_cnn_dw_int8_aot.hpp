...
inline constexpr const char* kName = "mnist_cnn_dw_int8";
...
inline constexpr std::size_t kActAElements = 25088u;
inline constexpr std::size_t kActBElements = 21632u;
inline constexpr std::size_t kWorkspaceBytes = 128u;

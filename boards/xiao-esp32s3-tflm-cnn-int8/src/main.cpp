// Seeed XIAO ESP32S3 — TFLM MNIST CNN int8 (esp-tflite-micro + ESP-NN).
...
// ESP32-S3 SRAM is tight with IDF; 96 KiB matches published NUCLEO A/B arena budget.
...
extern "C" void app_main(void)
{
    ...
    std::printf("\nTFLM XIAO ESP32S3 MNIST CNN int8 benchmark\n");
    std::printf("  backend:     tflm %s int8 (MCU ESP32S3)\n", TFLM_CNN_INT8_BACKEND_LABEL);

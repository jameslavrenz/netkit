# ESP32-P4-Function-EV — MNIST DS-CNN int8 (TFLM)
...
| Peer | [`../esp32-p4-function-ev-cnn-dw-int8/`](../esp32-p4-function-ev-cnn-dw-int8/README.md) |

```bash
make -C ../../benchmark/tflm export-cnn-dw-int8   # once
cd boards/esp32-p4-function-ev-tflm-cnn-dw-int8 && make
